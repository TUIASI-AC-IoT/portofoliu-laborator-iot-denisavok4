...
#define CONFIG_EXAMPLE_FIRMWARE_UPGRADE_URL "https://192.168.89.33:5000/firmware.bin" 
#define CONFIG_EXAMPLE_VERSION_URL  "https://192.168.89.33:5000/version" 
...
static void version_task(void *pvParameters)
{
    xEventGroupWaitBits(s_event_start_ota, BIT_BTN_PRESSED, pdTRUE, pdTRUE, portMAX_DELAY);
    char local_response_buffer[MAX_HTTP_OUTPUT_BUFFER + 1] = {0};
    esp_http_client_config_t config = {
        .host = CONFIG_EXAMPLE_VERSION_URL,
        .path = "/get",
        .query = "esp",
        .event_handler = _http_event_handler,
...
void app_main(void)
{
    ...
    if (connected) {
        ...
        xTaskCreate(version_task, "version_task", 8192, NULL, 5, NULL);
